                    ...
                    <div className="modal-box">
                        ...
                        <div className="modal-body">
                            <div className="form-group">
                                <label className="form-label">User ID (Số ID trên hệ thống)</label>
                                <input type="number" className="form-input" value={addUserId} onChange={(e) => setAddUserId(e.target.value)} placeholder="Ví dụ: 12" required />
                            </div>
                            <div className="form-group">
